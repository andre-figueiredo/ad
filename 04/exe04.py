""" Exercice 4: M/G/1 queue, two types of clients 
    (Customer2 with less priority) one queue without preemption """
...
### General values ----------------------------------------
seedVal = 123456		# Seed to start simulation
...
with open("traces4.1.csv", "w") as f:
    writer = csv.writer(f)
